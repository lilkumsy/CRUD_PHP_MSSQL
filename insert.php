        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="form-container">
                    ...
                    <h5 class="text-center mb-4 navy-blue-color">Insert Credit Information</h5>
                    <form method="post">
                        ...
                        <div class="form-group">
                            <label for="forcedSaleValue">Forced Sale Value:</label>
                    ...
                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                        ...
                        $forcedSaleValue = $_POST['forcedSaleValue'];

                        // Prepare and execute insertion query
                        $insertQuery = "INSERT INTO CreditSecurities (creditID, Description, ForcedSaleValue) VALUES (?, ?, ?)";
                        $params = array($creditID, $description, $forcedSaleValue);
